...
DECLARE_SOA_TABLE(DGTwoTrackCands, "AOD", "DGTWOTRACKCANDS",
                  ...
                  dg_two_track_cand::PosX,
                  dg_two_track_cand::PosY,
                  dg_two_track_cand::PosZ,
                  dg_two_track_cand::Px,
                  ...
                  dg_two_track_cand::MinimumDistanceFV0,
                  dg_two_track_cand::MinimumDistanceFDD);
} // namespace o2::aod

struct DgTwoTrackCandProducer {
  Produces<aod::DGTwoTrackCands> selectedCandidates;
  ...
  int8_t getStoredDistance(uint32_t distance) const { return std::min<uint32_t>(distance, MaxStoredDistance + 1); }
...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc) { return WorkflowSpec{adaptAnalysisTask<DgTwoTrackCandProducer>(cfgc)}; }
