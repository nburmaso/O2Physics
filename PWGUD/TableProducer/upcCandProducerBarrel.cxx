...
DECLARE_SOA_COLUMN(McCollisionIds, mcCollisionIds, std::vector<int32_t>);
...
struct UpcCandProducerBarrel {
  ...
  using CollisionsWithSelsMC = soa::Join<aod::Collisions, aod::EvSels, aod::McCollisionLabels>;
  ...
  void processMC(CollisionsWithSelsMC const& collisions, TracksWithPIDMC const& tracks, BCsWithSels const& bcs,
                 aod::FT0s const& ft0s, aod::FV0As const& fv0s, aod::FDDs const& fdds,
