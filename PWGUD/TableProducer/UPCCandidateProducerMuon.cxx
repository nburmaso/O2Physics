...
struct UpcCandProducerMuon {
  ...
  bool addToFwdTable(int64_t candId, int64_t trackId, uint64_t gbc, float trackTime, ForwardTracks const& fwdTracks, const o2::aod::McFwdTrackLabels* mcFwdTrackLabels)
  {
    ...
    udFwdTracksExtra(track.trackType(), track.nClusters(), track.pDca(), track.rAtAbsorberEnd(), track.chi2(), track.chi2MatchMCHMID(), -1., track.mchBitMap(), track.midBitMap(), track.midBoards());
  ...
  {
    fDoMC = false;
    createCandidates(fwdTracks, ambFwdTracks, bcs, collisions, fv0s, zdcs, (o2::aod::McFwdTrackLabels*)nullptr);
  }
                    ...
                    o2::aod::McFwdTrackLabels const& mcFwdTrackLabels)
  {
    ...
    createCandidates(fwdTracks, ambFwdTracks, bcs, collisions, fv0s, zdcs, &mcFwdTrackLabels);
    fNewPartIDs.clear();
  }
...
{
  return WorkflowSpec{adaptAnalysisTask<UpcCandProducerMuon>(cfgc)};
}
